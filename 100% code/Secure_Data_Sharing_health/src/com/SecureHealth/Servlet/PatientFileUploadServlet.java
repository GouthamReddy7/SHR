...
import com.SecureHealth.crypto.AES;
...
/**
 * Servlet implementation class PatientFileUploadServlet
 */
@WebServlet("/PatientFileUploadServlet")
public class PatientFileUploadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PatientFileUploadServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String to= request.getParameter("doctorlogin");
		
		System.out.println("The value of doctor id is: "+to);
		...
		String fullpath=editpath+"Secure_Data_Sharing_health\\WebContent\\LOCAL\\";
		...
		while((part=mp.readNextPart())!=null)
			{
				...
				String encrpt = null;
				  ...
				  if (filename.endsWith(".txt")) {
		            ...
		            filepath1 = editpath + "Secure_Data_Sharing_health/WebContent/Decrypt/"+filename;
		            ...
		            file1.createNewFile();
		              ...
		              //file decrypted and store into filepath2
		        		    ...
		        		    filepath2 = editpath + "Secure_Data_Sharing_health/WebContent/Decrypt/"+filename;
		            ...
		            file1.createNewFile();
		              ...
		              //file decrypted and store into filepath2
		                ...
		                bean.setUsername(patientlogin);
		                bean.setTo(doctorlogin);
		                ...
		                if(f==1){
		                	...
		                	/////////////////////////
               response.sendRedirect("UploadPatientFile.jsp?success=1");
