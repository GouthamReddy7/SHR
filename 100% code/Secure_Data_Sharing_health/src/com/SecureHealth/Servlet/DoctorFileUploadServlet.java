...
/**
 * Servlet implementation class DoctorFileUploadServlet
 */
...
public class DoctorFileUploadServlet extends HttpServlet {
     ...
     */
    public DoctorFileUploadServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Doctorname:" +doctorlogin);
		...
		String to= request.getParameter("patientlogin");
		System.out.println("Patient name:" +user);
		            ...
		            file1.createNewFile();
		              ...
		              //file decrypted and store into filepath2
		                ...
		                if(f==1){
		                	...
		                	/////////////////////////
               response.sendRedirect("DoctorUploadFile.jsp?success=1");
