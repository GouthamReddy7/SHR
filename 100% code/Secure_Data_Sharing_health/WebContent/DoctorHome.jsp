...
<%
	String username = session.getAttribute("doctorlogin").toString();
%>
      <header>
               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav" style="margin-left:-50px;">
                        ...
                        <li><a data-scroll href="DoctorData.jsp">Doctor_Info</a></li>                      
                        <li><a data-scroll href="DoctorUploadFile.jsp">Upload_file</a></li>
                        <li><a data-scroll href="DoctorFileNotification.jsp">File_Notification</a></li>
						<li><a data-scroll href="DoctorPatientList.jsp">Patient_List</a></li>
						<li><a data-scroll href="DoctorDownload.jsp">Download_File</a></li>
