               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        <li><a class="active" href="">Cloud</a></li> 
                        <li><a data-scroll href="CloudViewUploadedFile.jsp">View_Uploadedfile</a></li>                      
                        <li><a data-scroll href="CloudDoctorInfo.jsp">Doctor_details</a></li>
                        <li><a data-scroll href="CloudHashData.jsp">Hash_Data</a></li>
						<li><a data-scroll href="CloudPatientList.jsp">Patient_List</a></li>
						<li><a data-scroll href="CloudDoctorList.jsp">Doctor_List</a></li>
