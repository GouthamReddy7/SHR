...
<!-- Basic -->
   ...
   <!-- Site Metas -->
   <title>Secure Data Sharing Health Records</title>
...
<body class="clinic_version">
      ...
      <!-- END LOADER -->
<%
	String username = session.getAttribute("patientlogin").toString();
%>
      <header>
            ...
            <div class="container">
               ...
               <div class="right-header">
                  ...
                  <div id="custom-search-input">
                     <form action="PatientHomeSearch.jsp" method="post"  class="contact-form">
                     <div class="input-group col-md-12">
                        <input type="text" class="form-control input-lg" name="contact_name" required placeholder="Search" style="border-style: solid; border-color: #001133; "/>
               ...
               <nav class="main-menu" >
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav" style="margin-left:-50px;">
                        ...
                        <li><a data-scroll href="DoctorInfo.jsp">View_doctor_list </a></li>
                        <li><a data-scroll href="PatientFileNotification.jsp">File_Notification</a></li>
                        <li><a data-scroll href="PatientHashData.jsp">Hash_Data</a></li>
						<li><a data-scroll href="UploadPatientFile.jsp">File_Upload</a></li>
						<li><a data-scroll href="PatientDownload.jsp">Download_File</a></li>
               ...
               <div class="col-md-12 col-sm-12">
                  <div class="text-contant">
                     <h2>
                        ...
                        <a href="" class="typewrite" data-period="2000" data-type='[ "Secure Data Sharing of", "Personal Health Records in Cloud", "Using Cryptographic Algorithm" ]'>
      ...
      <div id="about" class="section wow fadeIn">
         <div class="container">
            <div class="heading">
               ...
               <h2>Secure Heath Data Access</h2>
            </div>
            <!-- end title -->
            <div class="row">
               <div class="col-md-6">
                  <div class="message-box">
                     <h4>What We Do</h4>
                     <h2>Secure Data</h2>
                     <p class="lead">One of the well-known cryptographic cores that uses symmetric keys and provides superior security</p>
                     <p> Applying search operation on encrypted data and at the same occasion retrieve specific data from a huge amount of encrypted data as well as secure data sharing within a group of entities is the most challenging task.  </p>
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                  <div class="testimonial clearfix">
                     <div class="desc">
                        <h3><i class="fa fa-quote-left"></i> Share Data</h3>
                        <p class="lead">They Look into Patient record and share data with security provided</p>
                     </div>
                     <div class="testi-meta">
                        <img src="images/testi_01.png" alt="" class="img-responsive alignleft">
                        <h4>James Fernando <small>- Doctor </small></h4>
                     </div>
                     <!-- end testi-meta -->
                  </div>
                  <!-- end testimonial -->
               ...
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                  <div class="testimonial clearfix">
                     <div class="desc">
                        <h3><i class="fa fa-quote-left"></i> Receive and get to access data</h3>
                        <p class="lead">Patients can see through the prescription with authenticated process</p>
                     </div>
                     <div class="testi-meta">
                        <img src="images/testi_02.png" alt="" class="img-responsive alignleft">
                        <h4>Andrew Atkinson <small>- Patient</small></h4>
                     </div>
                     <!-- end testi-meta -->
                  </div>
                  <!-- end testimonial -->
            ...
            <div class="row">
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                  <div class="testimonial clearfix">
                     <div class="desc">
                        <h3><i class="fa fa-quote-left"></i> Authorizing the data</h3>
                        <p class="lead">Admin authorize and verify with the patients details.</p>
                     </div>
                     <div class="testi-meta">
                        <img src="images/testi_03.png" alt="" class="img-responsive alignleft">
                        <h4>Amanda DOE <small>- Admin</small></h4>
                     </div>
                     <!-- end testi-meta -->
                  </div>
                  <!-- end testimonial -->
               ...
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                  <div class="testimonial clearfix">
                     <div class="desc">
                        <h3><i class="fa fa-quote-left"></i> Maintains details</h3>
                        <p class="lead">Cloud maintains the details of data sharer and receiver</p>
                     </div>
                     <div class="testi-meta">
                        <img src="images/testi_01.png" alt="" class="img-responsive alignleft">
                        <h4>Martin Johnson <small>- Cloud</small></h4>
                     </div>
                     <!-- end testi-meta -->
                  </div>
                  <!-- end testimonial -->
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="logo padding">
                     ...
                     <p>To assign a privacy rating for identifying the essential component of a health record.</p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="footer-info padding">
                     <h3>CONTACT US</h3>
                     <p><i class="fa fa-map-marker" aria-hidden="true"></i> No.43 kmc Hospital mumbai</p>
                     <p><i class="fa fa-paper-plane" aria-hidden="true"></i> infohealthSecure@gmail.com</p>
                     <p><i class="fa fa-phone" aria-hidden="true"></i> (+91) 800 436 456 012</p>
                  </div>
               </div>
               <div class="col-md-4">
            ...
            <div class="row">
               <div class="col-md-8">
                  <div class="footer-text">
                     <p>© Secure Data sharing access.</p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="social">
