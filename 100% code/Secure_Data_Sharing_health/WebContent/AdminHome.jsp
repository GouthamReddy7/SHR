               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a data-scroll href="DoctorRequestAcceptByAdmin.jsp">Authenticate_Doctor</a></li>                      
                        <li><a data-scroll href="PatientRequestAcceptByAdmin.jsp">Authenticate_Patient</a></li>
                        <li><a data-scroll href="AdminHashData.jsp">Hash_Data</a></li>
						<li><a data-scroll href="AdminPatientList.jsp">Patient_List</a></li>
						<li><a data-scroll href="AdminDoctorList.jsp">Doctor_List</a></li>
