					...
					<table id="myTable" class="table table-bordred table-striped">
						...
						<%
							...
							try {
								...
								con2 = DatabaseConnection.createConnection();
								PreparedStatement ps2 = con2.prepareStatement("select * from filerequest where fileowner='"+doctor+"' and status='Waiting'");
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="AdminPatientFileAccept.jsp?ffilename=<%=rs.getString("filename")%>&reqby=<%=rs.getString("requestby") %>" class="btn btn-success btn-sm">Accept</a></td>
