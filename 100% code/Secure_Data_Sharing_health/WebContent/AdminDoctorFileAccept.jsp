...
try
{
    ...
    ResultSet rs=st.executeQuery("select * from patientuploadfile where filename='"+filename+"' and username='"+user+"'");
...
{   
	...
	ResultSet rs = st.executeQuery("SELECT * FROM doctorregister");
	...
	if(ans!=0)
	{
		...
		response.sendRedirect("DoctorRequestAcceptByAdmin.jsp?success=1");
