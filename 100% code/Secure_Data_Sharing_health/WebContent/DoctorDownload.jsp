...
<div class="container">
	<div class="row">
        ...
        <div class="navbar-header animated fadeInUp">
            <a class="btn btn-danger mt-2" href="DoctorHome.jsp">BACK</a>
        </div><br> <br> 
        <h4>Requested Files to Download <%=Doctor.toUpperCase()%></h4> <br> 
  ...
  <%                           
    try
    {
        ...
        ResultSet rs=st.executeQuery("select * from filerequest where requestby='"+Doctor+"'");
    %>
        <%
        int i=0;
        if(i<1)
